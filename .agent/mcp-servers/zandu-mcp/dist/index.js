 ...
 */
server.tool("get_persons", "Lista os clientes (pessoas) cadastrados no Zandu.", {
 ...
 */
server.tool("get_appointments", "Lista os agendamentos cadastrados na plataforma Zandu.", {
 ...
 */
server.tool("create_appointment", "Cria um novo agendamento no Zandu.", {
 ...
 */
server.tool("confirm_appointment", "Confirma a presença de um cliente em um agendamento específico.", {
 ...
 */
server.tool("get_invoices", "Lista as faturas (receitas) geradas no Zandu.", {
 ...
 */
server.tool("get_webhooks", "Lista os webhooks configurados no Zandu.", {}, async () => {
    try {
 ...
 */
server.tool("create_webhook", "Cria um novo webhook para receber notificações de eventos.", {
 ...
 */
server.tool("delete_webhook", "Remove um webhook existente.", {
